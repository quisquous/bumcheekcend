...
telescopeText["formidable stinger"] = $item[tropical orchid];
telescopeText["pair of horns"] = $item[barbed-wire fence];
...
telescopeText["wooden beam"] = $item[stick of dynamite];
